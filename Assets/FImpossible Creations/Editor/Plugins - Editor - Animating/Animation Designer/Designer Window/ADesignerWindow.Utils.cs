...
namespace FIMSpace.AnimationTools
{
    public partial class AnimationDesignerWindow : EditorWindow
    {
        ...
        public static string SaveClipPopup()
        {
            ...
            string filename = EditorUtility.SaveFilePanelInProject("Choose path to save animation clip file", Get.TargetClip.name + " - Modified" + verStr, "anim", "New Animation Clip Name", lastPath);
